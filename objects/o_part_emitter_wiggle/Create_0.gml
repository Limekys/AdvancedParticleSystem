...
pe = new advanced_part_emitter(ps, x-20 - 96, x+20 -96 + 40, y-20, y+20, x, y, aps_shape.line, aps_distr.linear);

part_type1 = new advanced_part_type();
with(part_type1) {
	part_life(100, 500);
	part_size(0.5, 1, 0.01, 0);
...
part_type_size(part, 0.5, 1, 0.01, 0);
